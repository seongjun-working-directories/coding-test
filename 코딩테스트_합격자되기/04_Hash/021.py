'''
[문제 021] - https://school.programmers.co.kr/learn/courses/30/lessons/131127
...
["banana", "apple", "rice", "pork", "pot"]	[3, 2, 2, 2, 1]	    ["chicken", "apple", "apple", "banana", "rice", "apple",    3
    ...
    for i in range(len(discount) - 9):
        ...
        for j in range(i, i+10):
            if discount[j] in want_dict:
                discount_10_days[discount[j]] = discount_10_days.get(discount[j], 0) + 1
        
        if discount_10_days == want_dict:
            answer += 1
